  ...
  const handlePrintTags = async (packageId, tagType) => {
    try {
      ...
      const tagsHtml = data.tags.map(t => {
        if (isId) {
          // FRONT side
          const front = `<div style="width:220px;background:#fff;border-radius:12px;box-shadow:0 3px 12px rgba(0,0,0,.2);overflow:hidden;page-break-inside:avoid;display:inline-block;margin:8px;vertical-align:top;border:1px solid #ddd">
          ...
          // BACK side - yellow with hotel/contact info
          const back = `<div style="width:220px;background:#f5c518;border-radius:12px;box-shadow:0 3px 12px rgba(0,0,0,.2);overflow:hidden;page-break-inside:avoid;display:inline-block;margin:8px;vertical-align:top">
          ...
          return `<div style="width:320px;height:200px;background:#fff;border-radius:10px;box-shadow:0 3px 12px rgba(0,0,0,.2);overflow:hidden;page-break-inside:avoid;display:inline-block;margin:10px;vertical-align:top;position:relative">
            ...
            <div style="margin-left:28px;display:flex;height:100%">
              ...
              <div style="width:100px;border-left:1px solid #eee;padding:8px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px">
                ...
                <div style="font-size:12px;font-weight:900;color:#1b5e20;text-align:center">TM FOUZY</div>
